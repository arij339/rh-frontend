...
// ─── SVG Icons ────────────────────────────────────────────────────────────────
const IC = {
  menu:     `<svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" viewBox="0 0 24 24"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>`,
...
<header class="navbar">
  ...
  <!-- Toggle -->
  <button class="toggle-btn" (click)="toggleSidebar.emit()" [innerHTML]="ic.menu | safeHtml"></button>
  ...
  styles: [`
    ...
    .toggle-btn {
      ...
      border-radius: 12px; padding: 12px; cursor: pointer; color: #475569;
      transition: all 0.2s; display: flex; align-items: center; justify-content: center;
      flex-shrink: 0; backdrop-filter: blur(10px);
      svg { display: block; }
      &:hover { background: rgba(14,157,175,0.1); border-color: #0e9daf; color: #0e9daf; transform: scale(1.05); }
...
export class NavbarComponent implements OnInit {
  ...
  /** Retourne l'icône SVG selon le type/couleur de notification */
